...
//#define OE_LOW()    digitalWrite(40, 0)   //Sets OE LOW
//#define CE_LOW()    digitalWrite(39, 0)   //Sets CE LOW
//#define WE_LOW()    digitalWrite(41, 0)   //Sets WE LOW
//#define WE_HIGH()   digitalWrite(41, 1)   //Sets WE HIGH
...
void setup()     
{
  ...
  Serial.begin(115200); // Initiate serial port data transmission at 9600 baud
...
void loop() 
{
    ...
    */
    ...
    for (address = 0; address < 0x8000; ++address)  //Start at 0, sequence through all (2^15) - 1 addresses
    {
        ...
        Serial.println(read_data(address));
    }
